(function ($) {
    $.fn.expandable = function(params) {
		...
		/*var $expand_bar = $('<a class="expand-bar "><span class="more">' + params.more
			...
			+ '</span><!--<i></i>--></a>');*/
			var $expand_bar = $('<div class="expand-bar"><a class="more">' + params.more
                            + '<i class="fas fa-angle-double-right"></i></a><a class="less" style="display: none">' + params.less
            			+ '<i class="fas fa-angle-double-right"></i></a><!--<i></i>--></div>');
